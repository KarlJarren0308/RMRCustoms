...
<div class="container-fluid">
    <div class="col-lg-3 col-md-3 fixed-position">
        <div class="list-group">
            ...
            <a href="transactions.php" class="list-group-item active-dark" data-toggle="popover" title="Transactions" data-content="Displays all active and inactive transactions made. This module also allows you to create new transactions."><h4 class="no-margin">Transactions</h4></a>
    ...
    <div class="col-lg-9 col-lg-offset-3 col-md-9 col-md-offset-3 fg-white auto-next-line">
        <div class="col-lg-3 col-md-3">
            <div class="form-group has-feedback">
                <input type="text" class="form-control" data-search="Transactions" placeholder="Search" autofocus>
                <span class="glyphicon glyphicon-search form-control-feedback fg-dark"></span>
            </div>
        </div>
        <div class="col-lg-9 col-md-9">
            <button data-execute="Create New Transaction" class="btn btn-primary pull-right"><span class="glyphicon glyphicon-plus"></span>&nbsp;&nbsp;&nbsp;Create New Transaction</button>
        </div>
...
<script>
    fillTable('list_transactions.php', '');
</script>
