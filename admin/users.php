...
<div class="container-fluid">
    <div class="col-lg-3 col-md-3 fixed-position">
        <div class="list-group">
            ...
            <a href="users.php" class="list-group-item" data-toggle="popover" title="Users" data-content="Manage users. This module allows you to add, edit or delete users. You may also set/unset modules he/she should/shouldn't use."><h4 class="no-margin">Users</h4></a>
            <?php
    ...
    <div class="col-lg-9 col-lg-offset-3 col-md-9 col-md-offset-3 fg-white auto-next-line">
        <div class="col-lg-3 col-md-3">
            <div class="form-group has-feedback">
                <input type="text" class="form-control" data-search="Users" placeholder="Search" autofocus>
                <span class="glyphicon glyphicon-search form-control-feedback fg-dark"></span>
            </div>
        </div>
        <div class="col-lg-9 col-md-9">
            <button data-execute="Add New User" class="btn btn-primary pull-right"><span class="glyphicon glyphicon-plus"></span>&nbsp;&nbsp;&nbsp;Add New User</button>
        </div>
