...
<div class="container-fluid">
    <div class="col-lg-3 col-md-3" style="position: fixed;">
        <div class="list-group">
            ...
            <a href="trucks.php" class="list-group-item active-dark" data-toggle="popover" title="Trucks" data-content="Displays information about the trucks."><h4 class="no-margin">Trucks</h4></a>
            <?php
    ...
    <div class="col-lg-9 col-lg-offset-3 col-md-9 col-md-offset-3 fg-white auto-next-line">
        <div class="col-lg-3 col-md-3">
            <div class="form-group has-feedback">
                <input type="text" class="form-control" data-search="Trucks" placeholder="Search" autofocus>
                <span class="glyphicon glyphicon-search form-control-feedback fg-dark"></span>
            </div>
        </div>
        <div class="col-lg-9 col-md-9">
            <button data-execute="Add New Truck" class="btn btn-primary pull-right"><span class="glyphicon glyphicon-plus"></span>&nbsp;&nbsp;&nbsp;Add New Truck</button>
        </div>
        <table id="listing" class="table table-hover table-striped table-bordered bg-white">
            <thead>
                <tr class="bg-dark">
                    <th width="20%">Truck Name</th>
