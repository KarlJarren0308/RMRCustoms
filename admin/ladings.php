...
<div class="container-fluid">
    <div class="col-lg-3 col-md-3 fixed-position">
        <div class="list-group">
            ...
            <a href="ladings.php" class="list-group-item active-dark" data-toggle="popover" title="Bill of Lading" data-content="Displays all bill of lading made. This module also allows you to create new bill of lading."><h4 class="no-margin">Bill of Lading</h4></a>
    ...
    <div class="col-lg-9 col-lg-offset-3 col-md-9 col-md-offset-3 fg-white auto-next-line">
        <div class="col-lg-3 col-md-3">
            <div class="form-group has-feedback">
                <input type="text" class="form-control" data-search="Ladings" placeholder="Search" autofocus>
                <span class="glyphicon glyphicon-search form-control-feedback fg-dark"></span>
            </div>
        </div>
        <div class="col-lg-9 col-md-9 text-right">
            <button data-execute="Create New Bill of Lading" class="btn btn-primary"><span class="glyphicon glyphicon-plus"></span>&nbsp;&nbsp;&nbsp;Create New Bill of Lading</button>
        </div>
        <table id="listing" class="table table-hover table-striped table-bordered bg-white">
            <thead>
                <tr class="bg-dark">
                    <th width="25%">Bill of Lading ID</th>
